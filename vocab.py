...
class VocabCreator:
    ...
    def __init__(self, file_known_terms=None, file_glove=None, load_embedding=True):
        ...
        file_known_terms: path
            The path of known_terms.txt file.
        file_glove: path
            The path of glove.txt file.
        load_embedding: bool
        ...
        self.words_emb: dict
            The dict containing for each index in the vocabulary the associated term in the embedding
